...
我前段时间刚好看到 V2EX API 2.0 的页面，就试了一下，当时还发现了一个小 [issue](https://www.v2ex.com/t/825436)，不过站长很快就解决了。那个时候正好还在放假，就想着学一下 iOS 开发，然后用这些 API 写一个客户端练手。目前只用了 SwiftUI 原生的组件，没有使用第三方库。因为才刚接触 Swift，基本是一边学一边写，所以很多地方的代码有点乱，等以后整理好了应该会开源。
