...
我前段时间看到 V2EX API 2.0 的页面，就试了试，当时还提了一个小 [Issue](https://www.v2ex.com/t/825436)，站长很快就修复了。那个时候刚好还在放假，想着入门一下 iOS 开发，然后用这些 API 写一个客户端练手。之后大概花了两周时间开发到当前版本，目前只用了 SwiftUI 原生的组件，没有使用第三方库。因为才刚接触 Swift，基本是一边学一边写，很多地方的代码还有点乱，等以后整理好了应该会开源。
